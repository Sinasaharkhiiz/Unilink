  ...
  <div class="album py-3" style="background-color: rgba(22, 24, 22, 0.88);">
    <div class="container" >
        <div style="width:100%; margin-bottom:15px;" class=" d-flex  justify-content-center align-items-center" data-bs-theme="dark">
            <form action="">
            <select class="form-select " " onchange="this.form.submit()" aria-label="Default select example" style="width: 300px" name="order">
                <option selected>{{"مرتب سازی براساس".$c_order}}</option>
