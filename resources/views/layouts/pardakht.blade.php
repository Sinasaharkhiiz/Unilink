<!DOCTYPE html>
<!-- saved from url=(0050)https://bpm.shaparak.ir/pgwchannel/startpay.mellat -->
<html lang="fa"><head><meta content="text/html; charset=UTF-8">
    ...
    <link href="{{ asset('includes/pardakht_files/esprit_fa.min.css') }}" rel="stylesheet">
...
<body id="body" class="up-scroll" >
	<header id="header">
		<div class="container">
			<div class="beh-card">
                <a class="change-languge" href="https://bpm.shaparak.ir/pgwchannel/startpay.mellat?lang=en">
                    EN</a>

				<div class="row">
					<div class="col shaparaklogo align-self-start"><img src="{{asset('includes/pardakht_files/shaparak_logo.svg')}}" alt="shaparak"></div>
					...
					<div class="col behpardakhtlogo align-self-start"><img src="{{asset('includes/pardakht_files/behpardakht_logo.svg')}}" alt="behpardakht"></div>
				</div>
			</div>
		</div>
	</header>
	...
	<div class="main-wrapper payment">
				...
				<div class="col-lg-8 col-md-12 col-sm-12 order-lg-1 order-2">
					<div class="beh-card carddetail">
						...
						<div class="card-header" id="cardheader">
							<h3>اطلاعات کارت</h3>
							<span id="remaining-time">زمان باقی مانده :<b>09:23</b></span>
						</div>
						<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-sm-8 col-12 mobile-justify">
										<div class="cardnumberbox" id="cardnumberbox">
                                            ...
                                            <input type="tel" id="cardnumber" maxlength="19" value="">
											...
											<div class="card-suggestionlist dropdown-menu" aria-labelledby="card-list-button" style="max-height: 329.7px;">
								...
								<div class="form-group row">
									...
									<div class="col-sm-1">
										<button type="button" id="cvv2KeyPad" class="form-btn keypad" tabindex="-1" ></button>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-2 col-sm-3 col-4">
										<input type="tel" class="form-control" id="inputmonth" maxlength="2" placeholder="ماه" autocomplete="off" >
									</div>
									<div class="col-md-2 col-sm-3 col-4">
										<input type="tel" class="form-control" id="inputyear" maxlength="2" placeholder="سال" autocomplete="off" >
									</div>
								</div>

                                <div class="form-group row" onblur="hideKeypad()">
                                    <div class="col-sm-4">
                                        <label for="inputcaptcha" class="col-form-label">کد امنیتی</label>
                                        <small>لطفا کد امنیتی داخل کادر را وارد نمایید</small>
                                    </div>

                                    <div class="col-md-6 col-sm-6 col-10 mobile-justify keypad-parent">
                                        <div class="cardnumberbox" id="input-captcha">
                                            <input type="tel" class="form-control" id="inputcaptcha" maxlength="5" autocomplete="off">
                                            <img class="captcha" id="captcha-img" src="{{asset('includes/pardakht_files/captchaimg.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-1 col-2">
                                        <button type="button" id="captcha-button" class="form-btn capcha" title="نمايش کد جديد" ></button>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-10 mobile-justify keypad-parent">
                                        <div class="cardnumberbox" id="dynamic-pin">
                                            <input type="password" class="form-control" id="inputpin" maxlength="12"
                                                   ">
                                            <button class="sendpin" type="button" id="otp-button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" tabindex="-1">دریافت رمز پویا
                                            </button>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 ">
                                        <button type="button" class="form-btn keypad" tabindex="-1" ></button>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-8 col-12 mobile-justify btn-submit-form">
                                        <span class="card-errorbox shaparak_sheet_message">لطفا اطلاعات مورد نیاز را به درستی وارد کنید</span>
                                    </div>
                                </div>
								<div class="form-group row">
									<div class="col-sm-4"></div>
									<div class="col-md-6 col-sm-8 col-12 mobile-justify btn-submit-form">
                                        <form class="needs-validation" style="display: inline" novalidate method="post" action="buy_course" enctype="multipart/form-data">
                                            ...
                                            <input type="submit" class="btn btn-perches" value="پرداخت" >
                                        </form>

										<button type="button" class="btn btn-decline" >انصراف</button>
									</div>
								</div>
					...
					<div class="beh-card merchantdetail">
						...
						<div class="card-body">
							...
							<div class="merchant-container">
								<div style="background: #8b2f2f" class="col-lg-12 col-sm-4 merchant-logo" onload="showLogoJustInMobile(event); ">
									<!--<img class=" " src="img/sample/merchant-logo.png" alt="merchantlogo">-->
									<img class=" " src="{{asset('includes/pardakht_files/ipg-defaltlogo.png')}}">
									<span class="helper"></span>
								</div>

								<ul class="col-lg-12 col-sm-8 merchant-detail">
									<li>نام پذیرنده : <b>شبکه ارتباطی دانشجویان UniLink</b></li>
									<li>شماره پذیرنده: <b>2433943</b></li>


                                    <li>شماره ترمینال: <b>6044267</b></li>
                                    <li>آدرس وب سایت: <b class="merchantwebsite"> www.unilik.ir</b></li>
							...
							<ul class="merchant-detail price">
								<li>مبلغ قابل پرداخت :<b class="price-number">{{$c_data->price}}0 &nbsp; ریال</b></li>
							</ul>
						</div>
		...
		<div class="keypad-container">
            ...
            <h4> <div class="input-group input-group-sm"> <span class="form-control border_none " aria-describedby="closeBtn"> صفحه کلید امن</span>  <div class="input-group-prepend "> <button id="closeBtn" type="button" class="close-button-pinpad" ></button> </div>   </div></h4>
			<div class="frame-umbtn"><button id="num1" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num2" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num3" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num4" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num5" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num6" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num7" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num8" type="button" class=" numpad" tabindex="-1" ></button></div>
            <div class="frame-umbtn"><button id="clear" type="button" class=" numpad" tabindex="-1" >⌫</button></div>
            <div class="frame-umbtn"><button id="num9" type="button" class=" numpad" tabindex="-1" ></button></div>
			<div class="frame-umbtn"><button id="num0" type="button" class=" numpad" tabindex="-1" ></button></div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="dynamic-pin-dialog-button" class="btn btn-primary" >متوجه شدم</button>
                    </div>
                </div>
            </div>
        </div>
	...
	<footer class="footer">
		<div class="container">
			...
			<div class="footerarc content">
				<span class="call">شماره تماس: 27312731-021 </span><br>
